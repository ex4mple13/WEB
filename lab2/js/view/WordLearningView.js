// js/view/WordLearningView.js

class WordLearningView {
    constructor() {
        // Elements for Learning Mode
        ...
        // Elements for Knowledge Control Mode
    ...
    // Methods for Knowledge Control Mode
    renderKnowledgeWord(englishWord) {
        ...
        if (this.nextKnowledgeWordBtn) this.nextKnowledgeWordBtn.style.display = 'none'; // Hide "Next Word" button
    }
    ...
    displayKnowledgeFeedback(isCorrect, correctTranslation = '') {
        ...
        if (this.nextKnowledgeWordBtn) this.nextKnowledgeWordBtn.style.display = 'block'; // Show "Next Word" button
    }
